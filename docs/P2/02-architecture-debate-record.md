...
=======
> 我们是 3 人学生团队，10 周内完成 CampusHub 校园互助服务平台 MVP。功能包括注册登录、需求发布、任务大厅、接单与订单状态流转、订单内留言、评价信用、举报审核和基础后台。不做在线支付、推荐算法、完整即时通讯，不希望引入 Redis、消息队列、网关等中间件。请推荐合适架构。
>>>>>>> b1eba33e1c9f6cffe6ea2403f33cae2d93387c83
