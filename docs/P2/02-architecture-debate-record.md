...
> 我们是 3 人学生团队，10 周内完成 CampusHub 校园互助服务平台 MVP。功能包括学校邮箱注册登录、需求发布、任务大厅、接单与订单状态流转、订单内实时文字和图片聊天、评价信用、举报审核和基础后台。技术栈已确定为前端 Vue3、后端 Java Spring Boot、数据库 MySQL。不做在线支付、推荐算法、语音/视频通话、群聊和位置共享，不希望引入 Redis、消息队列、网关等中间件。请推荐合适架构。
