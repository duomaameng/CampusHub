...
CREATE TABLE orders (
    ...
    service_provider_id BIGINT          NOT NULL                 COMMENT '服务方ID',
...
CREATE TABLE file_record (
    ...
    purpose         VARCHAR(20)     NOT NULL                 COMMENT '用途: AVATAR/TASK_IMAGE/COMPLETION_PROOF/MESSAGE_IMAGE/REPORT_EVIDENCE',
    created_at      DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
