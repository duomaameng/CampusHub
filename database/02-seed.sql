...
(1, 3, 'EXPRESS', '帮忙取快递', '需要帮忙从快递站取一个包裹并送到宿舍。', '仙林', '快递站到 9 栋宿舍', 'CASH', 5.00, DATE_ADD(NOW(), INTERVAL 1 DAY), 'OPEN', 0, JSON_OBJECT('pickupCode', 'ABCD1234', 'building', '9 栋宿舍'), 0),
(2, 2, 'SECOND_HAND', '出一本二手高数教材', '一本品相良好的二手高等数学教材，可线下交易。', '鼓楼', '教学楼 A 附近', 'CASH', 18.00, DATE_ADD(NOW(), INTERVAL 3 DAY), 'OPEN', 0, JSON_OBJECT('condition', '九成新', 'priceNote', '可小刀'), 0),
(3, 3, 'CONSULTATION', '匿名咨询保研复试经验', '想咨询复试准备和申请流程相关经验。', '仙林', '线上交流', 'NEGOTIABLE', NULL, DATE_ADD(NOW(), INTERVAL 2 DAY), 'OPEN', 1, JSON_OBJECT('topic', '保研复试'), 0),
(4, 2, 'ERRAND', '打印并送资料', '需要有人帮忙打印材料并送到图书馆门口。', '仙林', '打印店到图书馆', 'CASH', 8.00, DATE_ADD(NOW(), INTERVAL 12 HOUR), 'IN_PROGRESS', 0, JSON_OBJECT('pages', 24), 1);
